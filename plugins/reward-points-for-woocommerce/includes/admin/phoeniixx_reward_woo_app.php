...
/*8 august */
.top-left ul.android-ios.woo-app-page li.app_down a {
    color: #000;
    background: #fff;
    border: 1px solid #000;
}
.top-left ul.android-ios.woo-app-page li.download_buy_now a {
    color: #fff;
    background: #e7803e;
    border: 1px solid #e7803e;
    margin-left: 0px;
}
.top-left ul.android-ios.woo-app-page li.download_buy_now {
    margin-top: 42px;
}
    ...
    <div class="wrapper">
        ...
        <div class="top-section">
                ...
                <div class="top">
                   <div class="top-left">
                    ...
                    <p>Your WooCommerce store will be converted into an app. Connect to your WooCommerce store sync with your store Products.</p>
                     <!--<ul class="android-ios"><li> 
                      <a target="_blank" href="https://phoeniixx.com/woo-app/">Download Free Version</a></li></ul> -->
						<ul class="android-ios woo-app-page">
							<li class="app_down"><a target="_blank" href="https://play.google.com/store/apps/details?id=com.phoeniixx.wooapp">Download Android App Demo</a></li>
							...
							<li class="download_buy_now"> <a target="_blank" href="https://phoeniixx.com/woo-app/">Buy Now</a></li>
						</ul>
            ...
            <div class="top-right-image">
              ...
              <img src="/wp-content/plugins/reward-points-for-woocommerce/assets/images/App-1-2.png">
...
<li><a target="_blank" href="https://itunes.apple.com/in/app/woocommerce-admin/id1451481017?mt=8">Download iOS</a></li>
            ...
            <div class="top-right-image">
               <img src="/wp-content/plugins/reward-points-for-woocommerce/assets/images/App-2-3.png">
